...
# fit the models
m_glm = trophicSDM(Y=Y,X=X_raw,G=G,formulas=env.form,penal=NULL,sp.formula=sp.formula,sp.partition=NULL,method="glm",family=binomial(link = "logit"),iter=1000)
#m_glm_net = trophicSDM(Y=Y,X=X_raw,G=G,formulas=env.form,penal="elasticnet",method="glm",family=binomial(link = "logit"),iter=2000)
m_stan = trophicSDM(Y=Y,X=X_raw,G=G,formulas=env.form,penal=NULL,sp.formula=sp.formula,sp.partition=NULL,method="stan_glm",family=binomial(link = "logit"),iter=1000)
...
m_bayes = trophicSDM(Y=Y,X=X_raw,G=G,formulas=env.form,penal=NULL,sp.formula=sp.formula,sp.partition=NULL,method="bayesglm",family=binomial(link = "logit"),iter=1000)
