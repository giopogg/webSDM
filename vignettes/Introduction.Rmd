...
# X=cbind(1, poly(X_1,degree=2), poly(X_2,degree=2))
# X = cbind(1, X_1, X_2)
...
m = trophicSDM(Y = Y, X = X, G = G, 
               ...
               #env.formula = "~ I(X_1) + I(X_2)",
               #env.formula = "~ I(poly(X_1, degree = 2)) +  I(poly(X_2, degree = 2))",
...
CV = trophicSDM_CV(m, K = 5, prob.cov = T, iter = 2000,
...
CV_classic = trophicSDM_CV(m_classic, K = 5, prob.cov = T, iter = 2000,
                           pred_samples = 500, run.parallel = FALSE,
