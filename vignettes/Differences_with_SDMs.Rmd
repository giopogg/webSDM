---
title: "Subtles and obvious differences between SDM and trophic SDM"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Subtles and obvious differences between SDM and trophic SDM}
...
```{r igraph, warnings = FALSE,  message =FALSE}
library(igraph)
...
```
The relationship between the coefficients of the two models does not hold anymore more, and predictions are now different, with trophic SDM reaching a far better predictive accuracy than classic SDM for species 𝑦𝐵 (R2 of 0.83 and 0.96 respectively).

### Non-continous observable entities (presence-absence, counts) 
